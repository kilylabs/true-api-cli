...
class RetryCommand extends CodesCommand
{

	public function brief()
	{
		return 'SUZ codes retry command';
	}
	...
	public function options($opts)
	{
        ...
        $opts->add('block:','Block ID')->isa('string');
	...
	public function execute($action=null)
	{
        ...
        if(!$block_id = $opts->block) {
            throw new Exception("You need to define --block option");
        }
